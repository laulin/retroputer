example_spi: setup build_hal
	...
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/main_spi.o examples/main_spi.c
...
example_uart: setup build_hal
	# need apt install gcc-avr binutils-avr avr-libc avrdude
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/main_uart.o examples/main_uart.c
...
example_ps2: setup build_hal
	# need apt install gcc-avr binutils-avr avr-libc avrdude
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/main_ps2.o examples/main_ps2.c
...
system_check: setup build_hal
	# need apt install gcc-avr binutils-avr avr-libc avrdude
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/check.o tests/check.c
...
build_hal: setup
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/spi.o sources/spi.c
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/sram.o sources/sram.c
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/port_expander.o sources/port_expander.c
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/hw_uart.o sources/hw_uart.c
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/hp.o sources/hp.c
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/timer.o sources/timer.c
	avr-gcc -Os -std=c11 -DF_CPU=16000000UL -mmcu=atmega328p -I includes/ -c -o output/arduino/eeprom.o sources/eeprom.c
